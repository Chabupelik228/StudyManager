...
class ActionLog(Base):
    ...
    admin_name: Mapped[str | None] = mapped_column(String(255), nullable=True, index=True)
    action_type: Mapped[str | None] = mapped_column(String(255), nullable=True, index=True)
